...
Below are some explanations that will make these concepts easier to understand, but you need to be at least passingly familiar with the film *Pulp Fiction** to get the most out of the examples. If you have not seen the film, you should at least read 🔗 [the Wikipedia article](https://en.wikipedia.org/wiki/Pulp_Fiction) about it.
...
❓Describe the fabula and syuzhet of your favorite movie, book, and video game.
...
Form and genre are two important ways of describing the recognizable organization of narratives. Forms are the particular logical elements that may occur within a given narrative, while genres are arrangements of those elements as recognizable kinds of narrative.
...
❓What are the forms that have most gotten your attention in the last month? Here's a chicken-egg question: What came first? The narrative or the structure? 
...
When the formal elements of a genre are re-configured, they create new kinds of stories.  Below, you’ll find an example of genre expectation being violated. Extra-diegetic elements like the music and the narrator’s voice interrupt what we would expect. 
...
❓Find examples of the comic and tragic frames that are currently circulating in any media that you pay attention to.
...
The clip below, from a student at another university, captures both the “episodic” and the “thematic” frame as they appear in the political campaign speeches of several candidates in the 2012 presidential election.

* ⏯️ [Episodic and Thematic Frames](https://www.youtube.com/watch?v=R6K6SHsZyIs&t)


❓Find examples of the episodic and thematic frames that are currently circulating in any media that you pay attention to.
